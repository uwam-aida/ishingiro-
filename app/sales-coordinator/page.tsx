    ...
    const fetchSalesData = async () => {
      ...
      try {
        ...
        const [
          ...
          fetch(`${baseUrl}/production/details`, {
            headers,
          }),
          fetch(`${baseUrl}/factory/stock`, {
            headers,
          }),
          fetch(`${baseUrl}/sales/cake-orders`, {
            headers,
          }),
        ...
        <>
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              Track requests, stock, and product
